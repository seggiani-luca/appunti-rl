...
\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-15/tristate/tristate.v}
...
\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-15/tristate/n2to1_decoded_muxer.v}

da 4 a 1:

\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-15/tristate/n4to1_decoded_muxer.v}

da 8 a 1:

\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-15/tristate/n8to1_decoded_muxer.v}

e infine da 16 a 1:

\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-15/tristate/n16to1_decoded_muxer.v}
...
\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-15/tristate/tristate_fork.v}
...
\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-15/delay_buffers/posedge_delay_buffer.v}
...
\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-15/delay_buffers/negedge_delay_buffer.v}
...
\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-15/impulse_generators/posedge_impulse_generator.v}
...
\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-15/impulse_generators/negedge_impulse_generator.v}
