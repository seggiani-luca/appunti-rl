...
\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-09/decoders/n1to2_decoder.v}

Possiamo quindi definire il decoder da 2 a 4 visto prima:

\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-09/decoders/n2to4_decoder.v}

un decoder da 3 a 8:

\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-09/decoders/n3to8_decoder.v}

e infine, ad evidenziare quanto velocemente esplode il numero di termini (cioè esponenzialmente), un decoder da 4 a 16:

\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-09/decoders/n4to16_decoder.v}
...
\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-09/enb_decoders/n1to2_enb_decoder.v}

Possiamo quindi definire il decoder da 2 a 4:

\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-09/enb_decoders/n2to4_enb_decoder.v}

un decoder da 3 a 8:

\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-09/enb_decoders/n3to8_enb_decoder.v}

e infine, di cui notiamo la sintesi gerarchica molto più immediata rispetto al caso senza enabler, un decoder da 4 a 16:

\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-09/enb_decoders/n4to16_enb_decoder.v}
...
\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-09/demuxers/n1to2_demuxer.v}

e come se ne può ricavare uno da 1 a 4:

\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-09/demuxers/n1to4_demuxer.v}

da 1 a 8:

\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-09/demuxers/n1to8_demuxer.v}

e infine da 1 a 16:

\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-09/demuxers/n1to16_demuxer.v}
...
\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-09/muxers/n2to1_muxer.v}

e come se ne può ricavare uno da 4 a 1:

\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-09/muxers/n4to1_muxer.v}

da 8 a 1:

\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-09/muxers/n8to1_muxer.v}

e infine da 16 a 1:

\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-09/muxers/n16to1_muxer.v}
