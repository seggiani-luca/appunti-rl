...
\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-24/integer_utils/n4_c2_abs.v}
...
\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-24/c2_ms_converters/n4_c2_ms_converter.v}
...
\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-24/integer_utils/n4_c2_negator.v}
...
\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-24/field_extensors/b2_field_extensor.v}

Possiamo vedere anche l'implementazione per la base 10 in codifica BCD:

\lstinputlisting[language=verilog, style=codestyle]{../verilog/10-24/field_extensors/b10_field_extensor.v}
