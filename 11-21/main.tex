...
Finora abbiamo visto (# se uno ce le mettesse) descrizioni scritte attraverso il \textbf{linguaggio di trasferimento fra registri} del Verilog.
...
Prende in ingresso le variabili di condizionamento appena generate, e restituisce in uscita le variabili di comando dei multiplexer (#credo) della parte operativa.
